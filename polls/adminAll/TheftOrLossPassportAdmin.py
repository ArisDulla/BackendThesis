...
class TheftOrLossApplicationForm(ModelForm):
    def clean(self):
        ...
        serializer_data = {
            ...
            "police_report": cleaned_data.get("police_report"),
        ...
        serializer = TheftOrLossPassportSerializer(data=serializer_data)
...
class TheftOrLossApplicationAdmin(admin.ModelAdmin):
    form = TheftOrLossApplicationForm
    ...
    def police_report_pdf(self, instance):
        return self.render_file_image(instance, instance.police_report)
...
admin.site.register(TheftOrLossPassportApplication, TheftOrLossApplicationAdmin)
