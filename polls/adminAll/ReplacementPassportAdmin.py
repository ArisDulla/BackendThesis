...
class ReplacementPassportForm(ModelForm):
    def clean(self):
        ...
        serializer = ReplacementPassportSerializer(data=serializer_data)
...
class ReplacementPassportAdmin(admin.ModelAdmin):
    form = ReplacementPassportForm
...
admin.site.register(ReplacementPassportApplication, ReplacementPassportAdmin)
