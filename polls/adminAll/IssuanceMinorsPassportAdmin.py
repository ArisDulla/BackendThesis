...
class IssuanceMinorsApplicationForm(ModelForm):
    def clean(self):
        ...
        serializer_data = {
            ...
            "caregiver_address_certification": cleaned_data.get(
                "caregiver_address_certification"
            ),
            "convicted_declaration": cleaned_data.get("convicted_declaration"),
            "minor_age_declaration": cleaned_data.get("minor_age_declaration"),
        ...
        serializer = IssuanceMinorsPassportSerializer(data=serializer_data)
...
class IssuanceMinorsApplicationAdmin(admin.ModelAdmin):
    form = IssuanceMinorsApplicationForm
        ...
        (
            None,
            {
                "fields": (
                    ...
                    "payment_receipt_pdf",
                    "caregiver_address_certification",
                    "caregiver_address_certification_pdf",
                    "convicted_declaration",
                    "convicted_declaration_pdf",
                    "minor_age_declaration",
    ...
    def caregiver_address_certification_pdf(self, instance):
        return self.render_file_image(
            instance, instance.caregiver_address_certification
        )

    def convicted_declaration_pdf(self, instance):
        return self.render_file_image(instance, instance.convicted_declaration)

    def minor_age_declaration_pdf(self, instance):
        return self.render_file_image(instance, instance.minor_age_declaration)
